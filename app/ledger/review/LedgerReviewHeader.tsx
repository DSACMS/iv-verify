...
export default function LedgerReviewHeader({benefits, snapIncomeTotal, medicaidIncomeTotal}: ReviewHeaderProps) {
    ...
    if (benefits.medicaid && benefits.snap) {
        return (
            <div>
                <h3 className="margin-bottom-3">{t("review_header")}</h3>
        ...
        return (
            <div>
                <h3 className="margin-bottom-3">{t("review_medicaid_only_income", {amount: medicaidIncomeTotal})}</h3>
        ...
        return (
            <div>
                <h3 className="margin-bottom-3">{t("review_snap_only_income", {amount: snapIncomeTotal})}</h3>
